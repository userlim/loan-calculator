    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/[0.03] rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-[var(--text-muted)]">Use our calculator completely free with optional ads to support development.</p>
            </div>
            <div className="bg-white/[0.03] rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-[var(--text-muted)]">Available in 20 languages to serve users around the world.</p>
            </div>
            <div className="bg-white/[0.03] rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-[var(--text-muted)]">Get instant calculations with detailed amortization schedules.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="content-depth-section" className="mt-20 max-w-3xl mx-auto px-6 relative z-[1]">
        <h2 className="text-h2 mb-6 text-[var(--text-primary)]">Complete Guide</h2>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">How Loan Amortization Works</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Understanding Interest Rates: Fixed vs. Variable</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Types of Loans and Their Characteristics</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Strategies for Paying Off Loans Faster</h3>
            ...
            <div className="mb-6">
              <h3 className="text-h3 mb-2 text-[var(--text-primary)]">Key Metrics to Understand Before Borrowing</h3>
