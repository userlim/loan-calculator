        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/[0.03] rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-gray-400">Use our calculator completely free with optional ads to support development.</p>
            </div>
            <div className="bg-white/[0.03] rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-gray-400">Available in 20 languages to serve users around the world.</p>
            </div>
            <div className="bg-white/[0.03] rounded-2xl p-6 text-center shadow-sm">
              ...
              <p className="text-gray-400">Get instant calculations with detailed amortization schedules.</p>
            </div>
          </div>
        </div>
      </section>
